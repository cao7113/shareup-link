defmodule SlinkWeb.TestFormLive do
  ...
  def mount(params, session, socket) do
    Logger.info("mount with params and session: #{{params, session} |> inspect}")
    {:ok, socket}
  end

  @impl true
  def handle_params(params, uri, socket) do
    Logger.info("handle_params with params and uri: #{{params, uri} |> inspect}")
